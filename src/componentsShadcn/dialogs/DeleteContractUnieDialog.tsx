...
const DeleteContractUnieDialog = ({row,setCatchSelectedRows}:{row:any,setCatchSelectedRows:any}) => {
  const [loading, setLoading] = useState(false);
  const dispatch:AppDispatch=useDispatch();
  const deleteMultipleUnites=async()=>{
   let result=await DeleteMultipleContractUnites(row,setLoading,"landlord");
...
export default DeleteContractUnieDialog
