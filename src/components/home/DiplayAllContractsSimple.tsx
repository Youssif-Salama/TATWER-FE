...
const DiplayAllContractsSimple = () => {
  // Static variables
  const dispatch:AppDispatch=useDispatch();
  const getContractType = "tenant";
  const page = 1;
  const rowPerPage = 10;
  const showWay = "asc";
  ...
  return (
    ...
    <div className="overflow-x-auto rounded-md">
              ...
              <p className="text-[#0077bc]">عقود المؤجرين التي قربت علي الانتهاء</p>
...
export default DiplayAllContractsSimple;
