...
const EstateAddressForm = ({ formik }: { formik: any }) => {
        ...
        <form onSubmit={formik.handleSubmit} >
            <div className="w-full flex flex-col gap-4">
                ...
                <div className="flex items-center flex-wrap w-full gap-4 justify-between">
                    ...
                    <div className="w-[65%] max-md:w-[45%] max-sm:w-full">
                        <InputCommon type="text" required id="Link" name="Link" placeholder="ادخل رابط المبني هنا"
                        label="رابط المبني" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.Link} error={formik.errors && formik.touched.Link && formik.errors.Link}/>
                    </div>
                </div>
            </div>
        </form>
...
export default EstateAddressForm;
